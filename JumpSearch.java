...
public class JumpSearch {
    ...
    public JumpSearch() {
        ...
        f = new JFrame("Jump Search");

        l = new JLabel("Jump Search", JLabel.CENTER);
        ...
        prompt2.setBounds(150, 600, 50, 50);
