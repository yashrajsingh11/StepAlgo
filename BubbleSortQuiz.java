...
public class BubbleSortQuiz {
	...
	public BubbleSortQuiz() {
		
		f = new JFrame("Bubble Sort Quiz");
    	...
    	q1 = new JLabel("1. What is the worst case complexity of bubble sort?");
    	...
    	q2 = new JLabel("<html>2. The given array is arr = {1, 2, 4, 3}. Bubble sort is used to sort the array elements.<br>&nbsp;&nbsp;&nbsp;&nbsp;How many iterations will be done to sort the array?");
    	q2.setFont(new Font("Verdana", Font.PLAIN, 18));
        q2.setBounds(100, 200, 900, 50);

        rb21 = new JRadioButton("a) 4");
		...
		q3 = new JLabel("<html>3. Which of the following is not an advantage of optimised bubble sort over other<br>&nbsp;&nbsp;&nbsp;&nbsp;sorting techniques in case of sorted elements?<html>");
    	q3.setFont(new Font("Verdana", Font.PLAIN, 18));
        q3.setBounds(100, 300, 900, 50);

        rb31 = new JRadioButton("a) It is faster");
		rb31.setBounds(100, 350, 300, 40);
		rb31.setFont(new Font("Verdana", Font.PLAIN, 18));

		rb32 = new JRadioButton("b) Consumes less memory");
		rb32.setBounds(400, 350, 300, 40);
		rb32.setFont(new Font("Verdana", Font.PLAIN, 18));

		rb33 = new JRadioButton("<html>c) Detects whether the input<br>&nbsp;&nbsp;&nbsp; is already sorted</html>");
		rb33.setBounds(700, 350, 300, 50);
		rb33.setFont(new Font("Verdana", Font.PLAIN, 18));

		rb34 = new JRadioButton("d) Consumes less time");
		...
		q4 = new JLabel("4. What is the best case efficiency of bubble sort in the improvised version?");
