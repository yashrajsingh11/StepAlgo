...
public class LinearSearchQuiz {
	...
	public LinearSearchQuiz() {
		
		f = new JFrame("Linear Search Quiz");
    	...
    	q1 = new JLabel("1.  Where is linear searching used?");
    	q1.setFont(new Font("Verdana", Font.PLAIN, 18));
        q1.setBounds(100, 100, 900, 40);

        rb11 = new JRadioButton("<html>a) When the list has only<br>&nbsp;&nbsp;&nbsp; a few elements</html>");
		rb11.setBounds(100, 150, 300, 50);
		rb11.setFont(new Font("Verdana", Font.PLAIN, 18));

		rb12 = new JRadioButton("<html>&nbsp;&nbsp;&nbsp; When performing a<br>b) single search in an<br>&nbsp;&nbsp;&nbsp; unordered list</html>");
		rb12.setBounds(400, 120, 300, 80);
		rb12.setFont(new Font("Verdana", Font.PLAIN, 18));

		rb13 = new JRadioButton("c) Used all the time");
		rb13.setBounds(700, 150, 300, 40);
		rb13.setFont(new Font("Verdana", Font.PLAIN, 18));

		rb14 = new JRadioButton("<html>&nbsp;&nbsp;&nbsp; When the list has only a<br>b) few elements and When<br>&nbsp;&nbsp;&nbsp; performing a single search<br>&nbsp;&nbsp;&nbsp; in an unordered list</html>");
		rb14.setBounds(1000, 120, 300, 100);
    	...
    	q2 = new JLabel("2. What is the best case for linear search?");
		...
		q3 = new JLabel("3. What is the worst case for linear search?");
		...
		q5 = new JLabel("5. Which of the following is a disadvantage of linear search?");
    	q5.setFont(new Font("Verdana", Font.PLAIN, 18));
        q5.setBounds(100, 500, 900, 40);

        rb51 = new JRadioButton("a) Requires more space");
		...
		rb54 = new JRadioButton("d) Not easy to implement");
